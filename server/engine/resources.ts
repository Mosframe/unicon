...
export class Resources {
     ...
     * @memberof Resources
     */
    public static findObjectsOfTypeAll<T extends Ubject>( type?:IType<T> ) : T[] {
        if( !type ) {
            let t:IType<T>;
            type = t;
        }
        return <T[]>Resources.convertObjects( Resources._findObjectsOfTypeAll(type.toString()) );
    }
    /**
